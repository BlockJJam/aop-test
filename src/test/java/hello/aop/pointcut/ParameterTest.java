...
public class ParameterTest {
    ...
    static class ParameterAspect{
        ...
        @Before("allMember() && this(obj)") // obj == MemberService
        public void thisArgs(JoinPoint joinPoint, MemberService obj){
            log.info("[this] {}, obj={}", joinPoint.getSignature(), obj.getClass());
            // this == 프록시 객체 (현재: CGLIB객체)
        }

        @Before("allMember() && target(obj)") // obj == MemberService
        ...
        public void atAnnotationArgs(JoinPoint joinPoint, MethodAop annotation){ // MethodAop.value를 꺼낼 수 있다
